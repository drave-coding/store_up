...
const OTPModal = ({
  ...
  <AlertDialogContent className='shad-alert-dialog'>
    <AlertDialogHeader className='relative flex justify-center'>
      ...
      <AlertDialogDescription className='subtitle-2 text-center text-light-100'>Enter the OTP sent to{" "}
        <span className='pl-1 text-brand'>{email}</span> </AlertDialogDescription>
    </AlertDialogHeader>
    ...
    <AlertDialogFooter>
      <div className='flex w-full flex-col gap-4'>
        ...
        <div className='subtitle-2 text-center text-light-100 mt-2'>
          ...
          <Button 
          type='button' variant="link" className='pl-1 text-brand' onClick={handleResendOtp}>
            Click to resend
          </Button>
        </div>
      </div>
